...
config.resim_field_name = "resim_tm_grad_cross_cross"

config.input_map = tm_grad_cross_cross_rescan_map 

config.notes = "Re-scanning the Q,U map made from the gradient along the scan direction"
...
config.timestream_data_products = ["signal"]
