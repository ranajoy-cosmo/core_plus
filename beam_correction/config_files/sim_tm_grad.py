...
#sim_type can be "signal" OR "template"
config.sim_type = "template"

config.input_map = input_map
config.template_type = "tm_gradient"
#config.tm_gradient_type = ["tm_grad_co", "tm_grad_cross", "tm_grad_co_co", "tm_grad_cross_cross", "tm_grad_co_cross"]
config.tm_gradient_type = ["tm_grad_co_co", "tm_grad_cross_cross", "tm_grad_co_cross"]

config.notes = "Making the gradient templates for the pointing correction"
...
config.timestream_data_products = []

config.write_beam = True
config.beam_file_name = "full_simulated"
...
config.beam_type = "full_simulated"
