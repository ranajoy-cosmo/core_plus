...
config.sim_tag = "beam_correction_test_0"
...
config.bolo_config_file = "simulation.beam_correction.bolo_config_files.bolo_config" 
...
tm_grad_co_co_rescan_map = os.path.join(config.general_output_dir, config.sim_tag, "tm_grad_co_co", "sky_map.fits")
tm_grad_cross_cross_rescan_map = os.path.join(config.general_output_dir, config.sim_tag, "tm_grad_cross_cross", "sky_map.fits")
tm_grad_co_cross_rescan_map = os.path.join(config.general_output_dir, config.sim_tag, "tm_grad_co_cross", "sky_map.fits")
