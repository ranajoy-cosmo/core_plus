...
#bolo_config.bolos[bolo_name].fwhm_major = 8.61782017237                                         #arcmins
#bolo_config.bolos[bolo_name].fwhm_minor = 7.79756364198                                         #arcmins
bolo_config.bolos[bolo_name].fwhm_major = 8.0                                                   #arcmins
bolo_config.bolos[bolo_name].fwhm_minor = 8.0                                                   #arcmins
bolo_config.bolos[bolo_name].fwhm_effective = 8.0                                               #arcmins
