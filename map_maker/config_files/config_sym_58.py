...
config.sim_tag = "full_sky_4_bolos_mark"
...
config.map_making_tag = "sym_58_1_bolo_T_only"
...
#Default -> "TQU"
config.sim_pol_type = "T_only"

config.add_noise = False

config.do_pencil_beam = False

config.bolo_config_file = "4_bolos_gaussian_sym"
...
config.sampling_rate = 175                                  #Hz

config.alpha = 50.0                                #degrees
config.beta = 45.0                                #degrees

config.oversampling_rate = 2
