...
class Beam():
    ...
    def write_beam(self, out_dir=None):
        ...
        np.save(os.path.join(out_dir, self.config.tag), self.beam_kernel)
...
if __name__=="__main__":
    ...
    bolo_config = importlib.import_module("simulation.timestream_simulation.4_bolos_optimal").bolo_config
