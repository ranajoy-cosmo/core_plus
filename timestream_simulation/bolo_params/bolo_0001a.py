...
if scan_params.fixed_pointing_error == 0.0:
    bolo_params.del_x = 0.0
    bolo_params.del_y = 0.0
else:
    bolo_params.del_x = np.random.normal(loc=0.0, scale=scan_params.fixed_pointing_error)          #arc-seconds
    bolo_params.del_y = np.random.normal(loc=0.0, scale=scan_params.fixed_pointing_error)         #arc-seconds
...
#bolo_params.conv_fwhm = 2*2.5946893621894396                 #5% for 8'
