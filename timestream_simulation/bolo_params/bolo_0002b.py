...
bolo_params.pointing_offset_x = 0.0#np.random.normal(loc=0.0, scale=scan_params.fixed_pointing_error)          #arc-seconds
bolo_params.pointing_offset_y = 0.0#np.random.normal(loc=0.0, scale=scan_params.fixed_pointing_error)         #arc-seconds

#The angle the polarisation direction of the bolometer with the W-E axis measured anti-clockwise
bolo_params.pol_phase_ini = 135.0       #degrees

#The fwhm of the beam along two axes
bolo_params.fwhm = 7.0        #arcmin
bolo_params.conv_fwhm = 3.2078                               #7.7' for 7'
