...
bolo_config.input_beam_folder = "/project/projectdirs/core/sim/beams/nuim/square"
...
bolo_config.bolos[bolo_name].fwhm_major = 7.68                                #arcmins
bolo_config.bolos[bolo_name].fwhm_minor = 7.68                                #arcmins
...
#bolo_config.bolos[bolo_name].input_map = bolo_config.common_input_map
bolo_config.bolos[bolo_name].input_beam_file = os.path.join(bolo_config.input_beam_folder, "DRAG_CENTRAL_GRID_linypol.fits")
